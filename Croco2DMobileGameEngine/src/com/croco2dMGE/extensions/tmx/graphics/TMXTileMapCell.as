package com.croco2dMGE.extensions.tmx.graphics
{
	...
	import com.croco2dMGE.extensions.tmx.datas.TMXTilesetData;
	...
	public class TMXTileMapCell extends TileMapCell
	{
		...
		override public function onActive():void
		{
			...
			var tileTexture:Texture //= AssetManager(GlobalPropertyBag.get("AssetManager")).getTexture(tilesetData.imageData.path); 
