package com.croco2dMGE.input.controllers
{
	import com.croco2dMGE.CrocoEngine;
	import com.croco2dMGE.input.InputController;
	...
	public class KeyboardController extends InputController
	{
		...
		public function KeyboardController(name:String)
		{
			super(name);
		...
		private function onStageKeyDownHandler(e:KeyboardEvent):void
		{
			...
			{
				var a:Object;
				for each (a in mKeyActions[e.keyCode])
				{
		...
		{
			mKeyActions = [];
			CrocoEngine.input.stopContrllerActions(this);
		}
