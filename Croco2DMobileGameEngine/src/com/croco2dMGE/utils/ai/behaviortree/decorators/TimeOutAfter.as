...
{
	import com.croco2dMGE.utils.ai.behaviortree.base.Decorator;
	...
	public class TimeOutAfter extends Decorator
	{
		...
		public function TimeOutAfter(timeToWait:Number, child:Task, timeOutResult:TaskResult = null)
		{
			super(child);
		...
		{
			return new TimeOutAfter(timeToWait, child.clone(), timeOutResult);
		}
	}
}