package com.croco2dMGE.utils.ai.behaviortree.base
{
	...
	public class GroupOfTasks extends Task
	{
		...
		public function GroupOfTasks(failIfChildFailed:Boolean, 
									 ...
									 resultIfNoMoreChilden:TaskResult)
		{
			...
			this.failIfChildFailed = failIfChildFailed;
			this.successIfChildSucceeded = successIfChildSucceeded;
			this.resultIfNoMoreChilden = resultIfNoMoreChilden;
		}		
