package com.croco2dMGE.utils
{
	...
	public class ViewportGridUtil
	{
		...
		public function get minColStartIndex():int { return mValidMinColStartIndex };
		public function get maxColCount():int { return mValidMaxColCount };
		
		public function get minRowStartIndex():int { return mValidMinRowStartIndex };
		public function get maxRowCount():int { return mValidMaxRowCount };

		public function get viewPort():CrocoRect { return new CrocoRect(mViewPortX, mViewPortY, mViewPortWidth, mViewPortHeight); }
