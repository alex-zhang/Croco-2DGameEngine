package com.croco2d
{
	...
	public class AppConfig
	{
		...
		//----------------------------------------------------------------------
		//global.
		public static var KEY_APPBOOTSTRAP:String = "appBootstrap";
		public static var KEY_STARLING:String = "starling";
		public static var KEY_CROCO_ENGINE:String = "crocoEngine";
		
		public static var KEY_GLOBAL_ASSETS_MANAGER:String = "globalAssetsManager";
		...
		public static var KEY_SCREEN_ID:String = "screenId";
		public static var KEY_SCENE_ID:String = "sceneId";
		public static var KEY_HUB_SCREEN_ID:String = "hubScreenId";
		public static var KEY_SCEEN_ASSETS_MANAGER:String = "screenAssetsManager";
		
		public static var KEY_CAMERA:String = "camera";
		public static var KEY_INPUT_MANAGER:String = "inputManager";
		public static var KEY_SOUND_MANAGER:String = "soundManager";
