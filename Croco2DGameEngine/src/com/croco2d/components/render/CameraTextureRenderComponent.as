package com.croco2d.components.render
{
	...
	public class CameraTextureRenderComponent extends MonitorComponentBasic
	{
		public function CameraTextureRenderComponent()
		{
			super();
		}
		...
		override protected function onActive():void
		{
			...
			setBackBufferSize(CrocoEngine.stageWidth, CrocoEngine.stageHeight);
		...
		override protected function onDeactive():void
		{
			...
			CrocoEngine.instance.removeEventListener(CrocoEngine.EVENT_STAGE_RESIZE, stageResizeHandler);
